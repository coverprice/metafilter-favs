...
function init() {
	...
	for(i = 0; i < comments.length; i++) {
		...
		var smallcopy = Util.getNodes('.//span[@class="smallcopy"]', comment_div)[0];
		...
		if(first_br !== undefined && first_br.tagName === "BR") {
			var second_br = first_br.nextElementSibling;
			if(second_br !== undefined && second_br.tagName === "BR") {
				Util.removeElement(second_br);
			}
